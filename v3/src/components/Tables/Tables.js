...
class Tables extends Component {
  ...
  handleBooking = event => {
    ...
    if (
      formData.startDate < this.state.currentDate ||
      ...
      return (
        <Redirect
          to={{
            ...
            state: { model: this.state.currentSelected }
          }}
        />
      );
    } else {
          ...
          <Table>
            <TableHead>
              <TableRow style={{ backgroundColor: "#425563" }}>
                ...
                <TableCell>Storage Info</TableCell>
                <TableCell>Check Health</TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
