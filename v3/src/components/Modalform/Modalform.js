...
import MyError from "../UI/Error/Error";
import {
  Grid,
  Paper,
  Card,
          ...
          <Card>
            <CardContent>
              ...
              <form onSubmit={this.props.booking}>
                ...
                {console.log("test", this.props.tablesData.error)}
                <Button disabled={this.props.tablesData.error}>Hi</Button>
                <MyError str={this.props.tablesData.error} />
              </form>
            </CardContent>
          </Card>
        </div>
